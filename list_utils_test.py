...
def test_replace_all_in_list():
    assert replace_all_in_list([None, "#", "546", 33, None], None, "#") == ["#", "#", "546", 33, "#"]
    assert replace_all_in_list([1, 2, 3, 4, 5, 6], "e", 42) == [1, 2, 3, 4, 5, 6]
    assert replace_all_in_list([], 34, 43) == []
    
def test_replace_all_in_matrix():
    assert replace_all_in_matrix([[None, None, 2, None], [4, 5, "#"]], "k", 42) == [[None, None, 2, None], [4, 5, "#"]]
